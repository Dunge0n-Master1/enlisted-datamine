...
let { bqSendEvent } = require("%enlist/options/bigQuery.nut")
...
let function goToStep(idxOrId) {
  ...
  if (idx in steps) { // warning disable: -in-instead-contains
...
console_register_command(finishTutorial, "tutorial.closeCurrentTutorial")
