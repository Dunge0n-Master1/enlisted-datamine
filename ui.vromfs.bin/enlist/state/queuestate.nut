...
let clusterState = require("%enlist/clusterState.nut")
let selfClusters = clusterState.clusters
...
let function recalcSquadClusters(...) {
  if (isSquadLeader.value)
    squadSharedData.clusters(clone selfClusters.value)
}
