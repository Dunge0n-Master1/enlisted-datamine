...
let buildingTemplates = mkWatched(persist, "buildingTemplates", [])
let buildingUnlocks = mkWatched(persist, "buildingUnlocks", [])
let availableBuildings = mkWatched(persist, "availableBuildings", [])
let availableStock = mkWatched(persist, "availableStock", 0.0)
let requirePrice = mkWatched(persist, "requirePrice", [])
let buildingLimits = mkWatched(persist, "buildingLimits", [])
let selectedBuildingAllowRepair = mkWatched(persist, "selectedBuildingAllowRepair", false)
let buildingRepairText = mkWatched(persist, "buildingRepairText", "hud/resupply_cannon")
let buildingAllowRecreates = mkWatched(persist, "buildingAllowRecreates", [])
let isBuildingToolEquipped = mkWatched(persist, "isBuildingToolEquipped", false)
let isBuildingAlive = mkWatched(persist, "isBuildingAlive", true)
let canInteractWithDeadBuilding = mkWatched(persist, "canInteractWithDeadBuilding", false)
let isBuildingToolAvailable = mkWatched(persist, "isBuildingToolAvailable", true)
...
let selectedBuildingName = mkWatched(persist, "selectedBuildingName")
let selectedBuildingEid = mkWatched(persist, "selectedBuildingEid")
let selectedDestroyableObjectName = mkWatched(persist, "selectedDestroyableObjectName")
let buildingPreviewId = mkWatched(persist, "buildingPreviewId")
