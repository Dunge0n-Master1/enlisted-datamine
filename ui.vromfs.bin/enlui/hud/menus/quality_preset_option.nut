...
let mapOptionsByPreset = {
  ...
  [optGiQuality]                 = ["low",     "medium", "medium", "high",     "high"],
  [optAnisotropy]                = [1,         2,        4,        8,          16],
  [optTaaQuality]                = [0,         0,        1,        1,          2],
  [optSkiesQuality]              = ["low",     "low",    "medium", "high",     "high"],
  [optSsaoQuality]               = ["low",     "low",    "medium", "high",     "high"],
  [optShadowsQuality]            = ["minimum", "low",    "low",    "medium",   "high"],
  ...
  [optTaaMipBias]                = [0.0,       -0.15,    -0.5,     -0.5,       -1.0],
  [optOnlyonlyHighResFx]         = ["lowres",  "lowres", "lowres", "combined", "highres"],
  [optDropletsOnScreen]          = [false,     false,    true,     true,       true],
  ...
  [optSSSS]                      = [false,     false,    false,    true,       true],
}
