...
let missions = {
  volokolamsk_city_assault_ussr = {
    image = "ui/volokolamsk_city_02.jpg"
  ...
  volokolamsk_city_bomb = {
    image = "ui/volokolamsk_city_03.jpg"
  ...
  volokolamsk_forestry_inv_ussr = {
    image = "ui/volokolamsk_forestery_01.jpg"
  ...
  volokolamsk_forestry_inv_counter_ussr = {
    image = "ui/volokolamsk_forestery_02.jpg"
  ...
  volokolamsk_fortification_inv_ussr = {
    image = "ui/volokolamsk_fortification_01.jpg"
  ...
  volokolamsk_grove_inv = {
    image = "ui/volokolamsk_grove_01.jpg"
  ...
  volokolamsk_grove_inv_counter = {
    image = "ui/Volokolamsk_Birch_Grove_Inv_02.jpg"
  ...
  volokolamsk_lake_inv_ussr = {
    image = "ui/volokolamsk_lake_01.jpg"
  ...
  volokolamsk_manor_assault_ussr = {
    image = "ui/volokolamsk_manor_02.jpg"
  ...
  volokolamsk_monastery_inv_ussr = {
    image = "ui/volokolamsk_monastery_01.jpg"
  ...
  volokolamsk_quarry_inv_ussr = {
    image = "ui/volokolamsk_quarry_1.jpg"
  ...
  volokolamsk_quarry_inv_counter_ussr = {
    image = "ui/volokolamsk_quarry_2.jpg"
  ...
  volokolamsk_village_assault_ussr = {
    image = "ui/volokolamsk_village_02.jpg"
  ...
  volokolamsk_village_inv_ussr = {
    image = "ui/volokolamsk_village_01.jpg"
  ...
  volokolamsk_village_inv_counter = {
    image = "ui/volokolamsk_village_03.jpg"
  ...
  volokolamsk_voskhod_inv = {
    image = "ui/volokolamsk_voskhod_inv_01.jpg"
  ...
  volokolamsk_voskhod_inv_counter = {
    image = "ui/volokolamsk_voskhod_inv_03.jpg"
  ...
  normandy_aerodrome_inv_counter = {
    image = "ui/normandy_airfield_03.jpg"
  ...
  normandy_aerodrome_bomb = {
    image = "ui/normandy_airfield_02.jpg"
  ...
  normandy_beach_inv = {
    image = "ui/normandy_beach_inv_01.jpg"
  ...
  normandy_city_inv_allies = {
    image = "ui/normandy_city_dom_03.jpg"
  ...
  normandy_city_inv_counter_allies = {
    image = "ui/normandy_city_dom_02.jpg"
  ...
  normandy_coast_city_assault = {
    image = "ui/normandy_coast_city_02.jpg"
  ...
  normandy_coast_city_inv = {
    image = "ui/normandy_coast_city_03.jpg"
  ...
  normandy_omer_inv = {
    image = "ui/normandy_urban_omer_01.jpg"
  ...
  normandy_omer_inv_counter = {
    image = "ui/normandy_urban_omer_02.jpg"
  ...
  normandy_station_inv = {
    image = "ui/normandy_station_inv_01.jpg"
  ...
  normandy_station_inv_counter = {
    image = "ui/normandy_station_inv_02.jpg"
  ...
  normandy_station_conf = {
    image = "ui/normandy_station_inv_03.jpg"
  ...
  normandy_station_bomb = {
    image = "ui/normandy_station_inv_04.jpg"
  ...
  normandy_village_inv = {
    image = "ui/normandy_village_01.jpg"
  ...
  normandy_village_bomb = {
    image = "ui/normandy_village_04.jpg"
  ...
  berlin_chancellery_conf = {
    image = "ui/berlin_chancellery_dom_04.jpg"
  ...
  berlin_chancellery_inv = {
    image = "ui/berlin_chancellery_dom_05.jpg"
  ...
  berlin_garden_assault = {
    image = "ui/berlin_garden_inv_02.jpg"
    locId = "lobbies/berlin_garden_assault"
    type = MissionType.ASSAULT
  }

  berlin_garden_inv = {
    image = "ui/berlin_garden_inv_01.jpg"
  ...
  berlin_goering_inv = {
    image = "ui/berlin_goering_dom_01.jpg"
    locId = "lobbies/berlin_goering_inv"
  }

  berlin_ministry_inv = {
    image = "ui/berlin_moat_02.jpg"
  ...
  berlin_opera_inv = {
    image = "ui/berlin_opera_inv_01.jpg"
  ...
  berlin_station_inv = {
    image = "ui/berlin_station_03.jpg"
  ...
  berlin_station_bomb = {
    image = "ui/berlin_station_04.jpg"
  ...
  berlin_bridge_inv = {
    image = "ui/berlin_bridge_inv_03.jpg"
  ...
  berlin_railway_conf = {
    image = "ui/berlin_railway_inv_03.jpg"
  ...
  berlin_railway_inv = {
    image = "ui/berlin_railway_inv_02.jpg"
  ...
  berlin_wilhelm_inv = {
    image = "ui/berlin_wilhelm_02.jpg"
    locId = "lobbies/berlin_wilhelm_inv"
  }

  tunisia_city_bomb = {
    image = "ui/tunisia_city_inv_02.jpg"
  ...
  tunisia_cave_inv = {
    image = "ui/tunisia_cave_inv_01.jpg"
  ...
  tunisia_city_inv = {
    image = "ui/tunisia_city_inv_01.jpg"
  ...
  tunisia_farm_inv_counter = {
    image = "ui/tunisia_farm_inv_02.jpg"
  ...
  tunisia_farm_conf = {
    image = "ui/tunisia_farm_inv_04.jpg"
  ...
  tunisia_fortress_inv = {
    image = "ui/tunisia_fortress_inv_02.jpg"
  ...
  tunisia_gorge_bomb = {
    image = "ui/tunisia_gorge_inv_01.jpg"
  ...
  tunisia_gorge_inv = {
    image = "ui/tunisia_gorge_inv_02.jpg"
  ...
  tunisia_gorge_inv_counter = {
    image = "ui/tunisia_gorge_inv_03.jpg"
  ...
  tunisia_oasis_inv = {
    image = "ui/Tunisia_Oasis_Inv_01.jpg"
  ...
  stalingrad_univermag_inv = {
    image = "ui/stalingrad_inv_04.jpg"
  ...
  stalingrad_univermag_conf = {
    image = "ui/stalingrad_inv_06.jpg"
  ...
  stalingrad_univermag_inv_counter = {
    image = "ui/stalingrad_inv_01.jpg"
  ...
  stalingrad_communist_bomb = {
    image = "ui/stalingrad_inv_03.jpg"
  ...
  stalingrad_entrance_inv = {
    image = "ui/stalingrad_tractor_plant_04.jpg"
  ...
  stalingrad_entrance_inv_counter = {
    image = "ui/stalingrad_tractor_plant_07.jpg"
  ...
  stalingrad_entrance_conf = {
    image = "ui/stalingrad_tractor_plant_02.jpg"
  ...
  stalingrad_entrance_bomb = {
    image = "ui/stalingrad_tractor_plant_03.jpg"
  ...
  stalingrad_entrance_bomb_counter = {
    image = "ui/stalingrad_tractor_plant_08.jpg"
  ...
  pacific_guadalcanal_conf = {
    image = "ui/pacific_guadalcanal_inv_11.jpg"
  ...
  pacific_vertical_inv_counter = {
    image = "ui/pacific_guadalcanal_inv_13.jpg"
